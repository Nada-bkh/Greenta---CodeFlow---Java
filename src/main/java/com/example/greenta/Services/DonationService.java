...
public class DonationService {
    ...
    public List<Donation> showDonation() {
        ...
        try {Connection connection1 = MyConnection.getInstance().getConnection();
            ...
            while (rs.next()) {
                ...
                Charity charity = c.showCharityByName(rs.getString(4));
    ...
    public List<Donation> getTopDonors() {
        ...
        String sql = "SELECT * FROM Donation ORDER BY amount DESC LIMIT 3";
        try (Connection connection = MyConnection.getInstance().getConnection();
            ...
            while (resultSet.next()) {
                ...
                // Assuming you also want to fetch Charity information for each donation
                // You can fetch it similarly to how you did in the showDonation method
                // CharityService charityService = new CharityService();
                // Charity charity = charityService.showCharityByName(resultSet.getString("charity_name"));
                // Replace the above two lines with your implementation

                Donation donation = new Donation(id, address, date, firstName, lastName, phoneNumber, amount, null); // Replace null with charity object
