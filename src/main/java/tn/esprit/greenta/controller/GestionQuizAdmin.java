...
public class GestionQuizAdmin {
                ...
                protected void updateItem(Void item, boolean empty) {
                    ...
                    if(empty){
                        ...
                        addQuiz.setOnAction(event->{
                            ...
                            idQuiz=quiz.getId();
                            FXMLLoader fxmlLoader = new FXMLLoader(FXMain.class.getResource("gestion-question-admin.fxml"));
                            Scene scene = null;
                            try {
    ...
    void retour(ActionEvent event) {
        FXMLLoader fxmlLoader = new FXMLLoader(FXMain.class.getResource("gestion-cour-admin.fxml"));
        Scene scene = null;
        try {
            scene = new Scene(fxmlLoader.load());
        } catch (IOException e) {
